void __stdcall JsonSerializer__deserializeSpecializationImpl_object__uint_(Il2CppObject **dst, System_String_o *json, const MethodInfo_199CBE0 *method)
{
  Il2CppObject *v6; // rax
  __int64 *v7; // rdx
  bool v8; // zf
  ...
  __int64 v19; // rdx
  const MethodInfo_199CBE0_RGCTXs *v20; // rcx
  __int64 v21; // r8
...
LABEL_39:
  ...
  sub_1800162B0(1i64, v31, v30, v29);
}
