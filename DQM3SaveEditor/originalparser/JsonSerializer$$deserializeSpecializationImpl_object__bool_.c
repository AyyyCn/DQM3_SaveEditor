void __stdcall JsonSerializer__deserializeSpecializationImpl_object__bool_(Il2CppObject **dst, System_String_o *json, const MethodInfo_199C880 *method)
{
  Il2CppObject *v6; // rax
  __int64 *v7; // rdx
  bool v8; // zf
  ...
  __int64 v19; // rdx
  const MethodInfo_199C880_RGCTXs *v20; // rcx
  __int64 v21; // r8
...
LABEL_39:
  ...
  v29 = (unsigned __int8)v27[1].klass;
  v30 = *dst;
  ...
  sub_180015420(1i64, v31, v30, v29);
}
